...
## Deliverables
- [x] `Start over with voice` action clears in-progress draft and returns to recording flow
- [x] Existing draft can be discarded with explicit confirmation
- [x] New recording replaces prior transcript and generated content cleanly
