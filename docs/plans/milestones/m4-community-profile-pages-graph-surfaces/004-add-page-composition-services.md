...
## Goal
Create backend composition services that merge graph, badge, charity, and advice context into page-ready payloads.
...
- [ ] Advice payload shape supports 1-2 recommendations with optional fallback messaging.
...
## Verification
Call composition services for all three page types and verify complete payloads are returned even when graph or advice dependencies are unavailable.
