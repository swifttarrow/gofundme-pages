...
## Dependencies
- [x] Milestone 6
- [x] Mobile audio recording permissions and browser support confirmed
...
- [x] Component tests cover mic start/stop/pause/retry state transitions
- [x] Validation enforces recording hard cap at 90 seconds
- [x] Route tests confirm all entry points open the voice-first creation flow

### Manual Verification
- [x] Entry screen is mobile-friendly and presents voice as primary CTA
- [x] Recording shows live timer/waveform and rotating guidance prompts
- [x] User can switch to typing mode without losing flow context
