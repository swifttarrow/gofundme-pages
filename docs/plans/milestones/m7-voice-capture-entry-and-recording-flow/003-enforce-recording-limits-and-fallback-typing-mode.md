...
## Deliverables
- [ ] Soft guidance appears at 60 seconds and hard stop occurs at 90 seconds
- [ ] Validation blocks processing when no usable input is captured
- [ ] `Type instead` path uses the same downstream AI generation contract
